...
public class DatePicker extends LinearLayout implements Button.OnClickListener,
    ...
    public DatePicker(Context context, AttributeSet attrs) {
        ...
        mKeyBackgroundResId = R.drawable.betterpicker_key_background_dark;
        mButtonBackgroundResId = R.drawable.betterpicker_button_background_dark;
        ...
        mDeleteDrawableSrcResId = R.drawable.betterpicker_ic_backspace_dark;
        mCheckDrawableSrcResId = R.drawable.betterpicker_ic_check_dark;
    }

    protected int getLayoutId() {
        return R.layout.betterpicker_date_picker_view;
    }
    ...
    private class KeyboardPagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup collection, int position) {
            ...
            if (mDateFormatOrder[position] == DateFormat.MONTH) {
                ...
                view = mInflater.inflate(R.layout.betterpicker_keyboard_text, null);
                ...
                view = mInflater.inflate(R.layout.betterpicker_keyboard_right_drawable, null);
                View v1 = view.findViewById(R.id.first);
                View v2 = view.findViewById(R.id.second);
                View v3 = view.findViewById(R.id.third);
                View v4 = view.findViewById(R.id.fourth);
                ...
                view = mInflater.inflate(R.layout.betterpicker_keyboard, null);
                View v1 = view.findViewById(R.id.first);
                View v2 = view.findViewById(R.id.second);
                View v3 = view.findViewById(R.id.third);
                View v4 = view.findViewById(R.id.fourth);
